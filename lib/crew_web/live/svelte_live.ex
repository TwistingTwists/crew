defmodule CrewWeb.SvelteLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col justify-center items-center gap-4">
      ...
      <label>
        Amount:
        <input type="number" class="rounded" value={@amount} min="1" phx-keydown="update_amount" phx-keyup="update_amount" />
      </label>
    </div>
    """
  end
...
defmodule CrewWeb.LiveExample3 do
  use CrewWeb, :live_view
